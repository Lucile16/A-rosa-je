<template>
  <div class="annonce_component">
    ...
    <p class="mt-5">
      <small class="text-muted">Etat et createur : créé par créateur</small>
    </p>
  </div>
</template>

<script>
// import PlanteItem from "@/components/PlanteItem.vue";
...
export default {
  ...
  //     await this.getPlantes()
  // },

  // methods: {
  //     getPlantes: async function () {
  //     return await axios
  //         .get('https://dummyjson.com/plantes')
  //         .then((res) => {
