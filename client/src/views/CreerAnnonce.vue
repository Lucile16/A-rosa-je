<template>
  <form>
    ...
    <div>
      <label>
        Numéro de rue :
        <input v-model="annonce.adresse.numero" type="number" /> Rue :
        <input v-model="annonce.adresse.rue" type="text" /> Code postal :
        <input v-model="annonce.adresse.codePostal" type="number" /> Ville :
        <input v-model="annonce.adresse.ville" type="text" />
      </label>
    </div>
